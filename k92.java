class TimeTable{
    ...
    int[]period={1,2,3,4,6,7};
    String[]batch={"4MW24CS","4MW23CS","4MW22CS","4MW21CS"};
    String[]subject={"OOPJ","DSA","DDA","OB","PYTHON","MATHS","SOCIAL"};
    String[]Faculty={"Kuthya Sir","Chitra Madam","DEEPAK SIR","SAVITHA MAM","RESHMA MAM","RENITA MAM","SOUNDARY MAM"};
    boolean isLab;
    String section;
